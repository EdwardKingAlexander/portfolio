...
class="flex h-screen overflow-hidden bg-gray-100">
    ...
    <div :class="{'hidden' : open}" class="lg:hidden">
            ...
            <div class="pt-6 mt-6">
              <div class="px-2 space-y-1">
                ...
                <a href="#" class="flex items-center px-2 py-2 text-base font-medium rounded-md group text-cyan-100 hover:text-white hover:bg-cyan-600">
                  ...
                  <svg class="w-6 h-6 mr-4 text-cyan-300 group-hover:text-cyan-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div class="flex flex-col w-64">
        ...
        <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-cyan-700">
          ...
          <nav class="flex flex-col flex-1 mt-5 overflow-y-auto divide-y divide-cyan-800" aria-label="Sidebar">
            <div class="px-2 space-y-1">
              <!-- Current: "bg-cyan-800 text-white", Default: "text-cyan-100 hover:text-white hover:bg-cyan-600" -->
              <a href="#" class="flex items-center px-2 py-2 text-sm font-medium leading-6 text-white rounded-md bg-cyan-800 group" aria-current="page">
                <!-- Heroicon name: home -->
                <svg class="w-6 h-6 mr-4 text-cyan-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
        ...
        <div class="flex justify-between flex-1 px-4 sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
          ...
          <div class="flex items-center ml-4 md:ml-6">
            ...
            <div class="relative ml-3">
              <div>
                <button class="flex items-center max-w-xs text-sm bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50" id="user-menu" aria-haspopup="true">
