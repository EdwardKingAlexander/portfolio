    ...
    >
      ...
      <!--
        ...
        Leaving: "transition ease-in-out duration-300 transform"
          ...
          To: "-translate-x-full"
      -->
      <div class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-blue-400">
        ...
        <nav class="flex-shrink-0 h-full mt-5 overflow-y-auto divide-y divide-cyan-800" aria-label="Sidebar">
          <div class="px-2 space-y-1">
            ...
            <a href="{{ url('/admin') }}" class="flex items-center px-2 py-2 text-base font-medium text-blue-100 rounded-md hover:text-white hover:bg-blue-600 group" aria-current="page">
            ...
            <a href="{{ url('/admin/users') }}" class="flex items-center px-2 py-2 text-base font-medium text-blue-100 rounded-md hover:text-white hover:bg-blue-600 group">
              <!-- Heroicon name: outline/clock -->
              <svg class="w-6 h-6 mr-4 text-blue-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ '/admin/blog' }}" class="flex items-center px-2 py-2 text-base font-medium text-blue-100 rounded-md hover:text-white hover:bg-blue-600 group">
    ...
    <div class="flex flex-col w-64">
      ...
      <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-blue-700">
        ...
        <nav class="flex flex-col flex-1 mt-5 overflow-y-auto divide-y divide-cyan-800" aria-label="Sidebar">
          <div class="px-2 space-y-1">
            <!-- Current: "bg-blue-800 text-white", Default: "text-blue-100 hover:text-white hover:bg-blue-600" -->
            <a href="{{ url('/admin') }}" class="flex items-center px-2 py-2 text-sm font-medium leading-6 text-blue-100 rounded-md group hover:text-white hover:bg-blue-600" aria-current="page">
              <!-- Heroicon name: outline/home -->
              <svg class="w-6 h-6 mr-4 text-blue-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
            ...
            <a href="{{ url('/admin/users') }}" class="flex items-center px-2 py-2 text-sm font-medium leading-6 text-blue-100 rounded-md group hover:text-white hover:bg-blue-600">
              <!-- Heroicon name: outline/clock -->
              <svg class="w-6 h-6 mr-4 text-blue-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            ...
            <a href="{{ url('/admin/blog') }}" class="flex items-center px-2 py-2 text-sm font-medium leading-6 text-blue-100 rounded-md group hover:text-white hover:bg-blue-600">
              <!-- Heroicon name: outline/credit-card -->
              <svg class="w-6 h-6 mr-4 text-blue-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>              
