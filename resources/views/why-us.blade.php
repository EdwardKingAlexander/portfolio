  ...
  <div class="relative py-16 overflow-hidden bg-white">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto mt-6 prose prose-lg text-gray-500 prose-blue">
        ...
        <figure>
          <img class="w-full rounded-lg" src="{{ asset('img/sales.jpg') }}" alt="" width="1310" height="873">
          <figcaption>Increased sales and/or reduced expenses is how businesses grow.</figcaption>
        </figure>

        <h2>Technical expertise</h2>
        <p>When it comes to developing web applications and websites, there are many different technologies that can be used. While we focus on a particular technology to develop the majority of our services, we have the technical expertise to use many other technolgies. Our network of programmers allows us to complete almost any project according to your specific needs.</p>

        <p>So, why us? Because our background working with businesses in so many different industries gives us an edge over the many companies that design and develop websites. We focus on results, because thats what matters.</p>
      </div>
    </div>
  </div>
